...
{
    [SPECIES_NONE] = gMonFootprint_Paropeat,
    [SPECIES_PAROPEAT] = gMonFootprint_Paropeat,
    [SPECIES_MACAUMENT] = gMonFootprint_Macaument,
    [SPECIES_ARGUWINT] = gMonFootprint_Arguwint,
    [SPECIES_PRIMATIO] = gMonFootprint_Primatio,
    [SPECIES_OPINIMP] = gMonFootprint_Opinimp,
    [SPECIES_TEMPERILLA] = gMonFootprint_Temperilla,
    [SPECIES_SUBSTEE] = gMonFootprint_Substee,
    [SPECIES_MANEMBER] = gMonFootprint_Manember,
    [SPECIES_TRECHIBER] = gMonFootprint_Trechiber,
    [SPECIES_BULBITE] = gMonFootprint_Bulbite,
    [SPECIES_LAMPUPA] = gMonFootprint_Lampupa,
    [SPECIES_ELECREEP] = gMonFootprint_Elecreep,
    [SPECIES_ACTURUNK] = gMonFootprint_Acturunk,
    [SPECIES_DRAMASPIRE] = gMonFootprint_Dramaspire,
    [SPECIES_BURROBIT] = gMonFootprint_Burrobit,
    [SPECIES_RABBITATE] = gMonFootprint_Rabbitate,
    [SPECIES_CUCKOOB] = gMonFootprint_Cuckoob,
    [SPECIES_TWIDDIES] = gMonFootprint_Twiddies,
    [SPECIES_AIRIOLA] = gMonFootprint_Airiola,
    [SPECIES_STANDAAD] = gMonFootprint_Standaad,
    [SPECIES_RECKLOAT] = gMonFootprint_Reckloat,
    [SPECIES_DEVILOAT] = gMonFootprint_Deviloat,
    [SPECIES_KITKAR] = gMonFootprint_Kitkar,
    [SPECIES_CANNEKO] = gMonFootprint_Canneko,
    [SPECIES_GRUBFEED] = gMonFootprint_Grubfeed,
    [SPECIES_KWIZBEE] = gMonFootprint_Kwizbee,
    [SPECIES_COSMONARCH] = gMonFootprint_Cosmonarch,
    [SPECIES_PAASTEL] = gMonFootprint_Paastel,
    [SPECIES_SHEEPASTRY] = gMonFootprint_Sheepastry,
    [SPECIES_PIKASH] = gMonFootprint_Pikash,
    [SPECIES_SONIKACHU] = gMonFootprint_Sonikachu,
    [SPECIES_TYPURR] = gMonFootprint_Typurr,
    [SPECIES_CALIKEY] = gMonFootprint_Calikey,
    [SPECIES_SPOOKIDS] = gMonFootprint_Spookids,
    [SPECIES_TOGETERROR] = gMonFootprint_Togeterror,
    [SPECIES_BUBOZOA] = gMonFootprint_Bubozoa,
    [SPECIES_CHRYSAPOD] = gMonFootprint_Chrysapod,
    [SPECIES_ARGIGAMI] = gMonFootprint_Argigami,
    [SPECIES_DISPUTRAW] = gMonFootprint_Disputraw,
    [SPECIES_DISPUTRAW_SPECIAL] = gMonFootprint_DisputrawSpecial,
    [SPECIES_SPIRICK] = gMonFootprint_Spirick,
    [SPECIES_PLAGHOST] = gMonFootprint_Plaghost,
    [SPECIES_COVILED] = gMonFootprint_Coviled,
    [SPECIES_CONTRIP] = gMonFootprint_Contrip,
    [SPECIES_PLUNGEMENT] = gMonFootprint_Plungement,
    [SPECIES_ACCIDROP] = gMonFootprint_Accidrop,
    [SPECIES_CURSWORM] = gMonFootprint_Cursworm,
    [SPECIES_WINDOWORM] = gMonFootprint_Windoworm,
    [SPECIES_LOCKSMIAN] = gMonFootprint_Locksmian,
    [SPECIES_BINYOTAKE] = gMonFootprint_Binyotake,
    [SPECIES_SVAMPELETT] = gMonFootprint_Svampelett,
    [SPECIES_KRABADICT] = gMonFoorprint_Krabadict,
	[SPECIES_KETAGENE] = gMonFoorprint_Ketagene,
	[SPECIES_SHORTS] = gMonFoorprint_Shorts,
	[SPECIES_PANTS] = gMonFoorprint_Pants,
	[SPECIES_CACOBELLE] = gMonFoorprint_Cacobelle,
	[SPECIES_DELPHIER] = gMonFoorprint_Delphier,
	[SPECIES_ENTESAGT] = gMonFoorprint_Entesagt,
    [SPECIES_SKELIPEDE] = gMonFootprint_Skelipede,
    [SPECIES_COFFINSECT] = gMonFootprint_Coffinsect,
    [SPECIES_TERRACAL] = gMonFootprint_Terracal,
    [SPECIES_DIGFLOPPA] = gMonFootprint_Digfloppa,
	[SPECIES_TELECO] = gMonFoorprint_Teleco,
	[SPECIES_ESAKIT] = gMonFoorprint_Esakit,
	[SPECIES_FOREKAYE] = gMonFoorprint_Forekaye,
	[SPECIES_HELLMO] = gMonFoorprint_Hellmo,
    [SPECIES_RANDOMAIL] = gMonFootprint_Randomail,
    [SPECIES_DEDLIVERY] = gMonFootprint_Dedlivery,
    [SPECIES_SIXTEEVY] = gMonFootprint_Sixteevy,
    [SPECIES_TENEIDEEPI] = gMonFootprint_Teneideepi,
    [SPECIES_MLADIBUG] = gMonFootprint_Mladibug,
    [SPECIES_FLEXNAKE] = gMonFootprint_Flexnake,
    [SPECIES_FLEXAIL] = gMonFootprint_Flexail,
    [SPECIES_ETIKUB] = gMonFootprint_Etikub,
    [SPECIES_DESMANTHER] = gMonFootprint_Desmanther,
    [SPECIES_SUPPORPOD] = gMonFootprint_Supporpod,
    [SPECIES_FLYPOD] = gMonFootprint_Flypod,
    [SPECIES_VEESEE] = gMonFootprint_Veesee,
    [SPECIES_DRACORD] = gMonFootprint_Dracord,
    [SPECIES_DONKRIME] = gMonFootprint_Donkrime,
    [SPECIES_MAFIADASS] = gMonFootprint_Mafiadass,
    [SPECIES_MLGLOB] = gMonFootprint_Mlglob,
    [SPECIES_BRAIMATE] = gMonFootprint_Braimate,
    [SPECIES_CREWEBRAL] = gMonFootprint_Crewebral,
    [SPECIES_IMPVADER] = gMonFootprint_Impvader,
    [SPECIES_EXTERESSUS] = gMonFootprint_Exteressus,
    [SPECIES_ALSNOW] = gMonFootprint_Alsnow,
    [SPECIES_COOLLEM] = gMonFootprint_Coollem,
    [SPECIES_DARKORPSE] = gMonFootprint_Darkorpse,
    [SPECIES_FUNNESUS] = gMonFootprint_Funnesus,
    [SPECIES_PUPYRO] = gMonFootprint_Pupyro,
    [SPECIES_PYRULPES] = gMonFootprint_Pyrulpes,
    [SPECIES_KITSINICAL] = gMonFootprint_Kitsinical,
    [SPECIES_COMMUNYMPH] = gMonFootprint_Communymph,
    [SPECIES_MANTIFA] = gMonFootprint_Mantifa,
    [SPECIES_HATCHAAL] = gMonFootprint_Hatchaal,
    [SPECIES_CRUSYGLE] = gMonFootprint_Crusygle,
    [SPECIES_BUBBABE] = gMonFootprint_Bubbabe,
    [SPECIES_BUBBATH] = gMonFootprint_Bubbath,
    [SPECIES_BUBBLUST] = gMonFootprint_Bubblust,
    [SPECIES_CHANELING] = gMonFootprint_Chaneling,
    [SPECIES_TROLLMODEL] = gMonFootprint_Trollmodel,
    [SPECIES_SKORCHOP] = gMonFootprint_Skorchop,
    [SPECIES_CUBEAST] = gMonFootprint_Cubeast,
    [SPECIES_BEASTUNT] = gMonFootprint_Beastunt,
    [SPECIES_HOOTUBE] = gMonFootprint_Hootube,
    [SPECIES_CHANNOWL] = gMonFootprint_Channowl,
    [SPECIES_BROYALTY] = gMonFootprint_Broyalty,
    [SPECIES_FANDAM] = gMonFootprint_Fandam,
    ...
    [SPECIES_MUSTELIT] = gMonFootprint_Mustelit,
    [SPECIES_CAPENSEAR] = gMonFootprint_Capensear,
    [SPECIES_MAPIG] = gMonFootprint_Mapig,
    [SPECIES_PREDATOAR] = gMonFootprint_Predatoar,
    [SPECIES_ILLUMARYD] = gMonFootprint_Illumaryd,
    [SPECIES_ENLIMINATI] = gMonFootprint_Enliminati,
    [SPECIES_ASTLEYROID] = gMonFootprint_Astleyroid,
    [SPECIES_POSTLE] = gMonFootprint_Postle,
    [SPECIES_HUSHBACK] = gMonFootprint_Hushback,
    [SPECIES_SLICHIC] = gMonFootprint_Slichic,
    [SPECIES_MURDEROO] = gMonFootprint_Murderoo,
    [SPECIES_ROBBANK] = gMonFootprint_Robbank,
    [SPECIES_CORRIMINAL] = gMonFootprint_Corriminal,
    [SPECIES_VEGAVA] = gMonFootprint_Vegava,
    [SPECIES_GLUTTOCADO] = gMonFootprint_Gluttocado,
    [SPECIES_PLAYSTRIKE] = gMonFootprint_Playstrike,
    [SPECIES_EXBULK] = gMonFootprint_Exbulk,
    [SPECIES_TOUCHSPEED] = gMonFootprint_Touchspeed,
    [SPECIES_ZOUNO] = gMonFootprint_Zouno,
    [SPECIES_PHANESIS] = gMonFootprint_Phanesis,
    [SPECIES_BIOSSIL] = gMonFootprint_Biossil,
    [SPECIES_VIRANCIENT] = gMonFootprint_Virancient,
    [SPECIES_EVECHO] = gMonFootprint_Evecho,
    [SPECIES_BARSONIST] = gMonFootprint_Barsonist,
    [SPECIES_CHIPCHUNE] = gMonFootprint_Chipchune,
    [SPECIES_ORCLASSTRA] = gMonFootprint_Orclasstra,
    [SPECIES_RELAQUA] = gMonFootprint_Relaqua,
    [SPECIES_SQUEANIME] = gMonFootprint_Squeanime,
    [SPECIES_ENIGMASH] = gMonFootprint_Enigmash,
    [SPECIES_AIRPODON] = gMonFootprint_Airpodon,
    [SPECIES_MIKOMODO] = gMonFootprint_Mikomodo,
    [SPECIES_GOJIREC] = gMonFootprint_Gojirec,
    [SPECIES_EEKORONE] = gMonFootprint_Eekorone,
    [SPECIES_HALFIST] = gMonFootprint_Halfist,
    [SPECIES_INEVITON] = gMonFootprint_Ineviton,
    ...
    [SPECIES_EGG] = gMonFootprint_Paropeat,
};
