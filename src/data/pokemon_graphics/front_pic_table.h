...
const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CNIDETER, gMonFrontPic_Cnideter),
    SPECIES_SPRITE(TIDARIA, gMonFrontPic_Tidaria),
    ...
    SPECIES_SPRITE(MLGLOB, gMonFrontPic_Mlglob),
    ...
    SPECIES_SPRITE(CHANELING, gMonFrontPic_Chaneling),
    SPECIES_SPRITE(TROLLMODEL, gMonFrontPic_Trollmodel),
    ...
    SPECIES_SPRITE(MAPIG, gMonFrontPic_Mapig),
    SPECIES_SPRITE(PREDATOAR, gMonFrontPic_Predatoar),
    SPECIES_SPRITE(ILLUMARYD, gMonFrontPic_Illumaryd),
    SPECIES_SPRITE(ENLIMINATI, gMonFrontPic_Enliminati),
    SPECIES_SPRITE(ASTLEYROID, gMonFrontPic_Astleyroid),
    SPECIES_SPRITE(POSTLE, gMonFrontPic_Postle),
    SPECIES_SPRITE(HUSHBACK, gMonFrontPic_Hushback),
    SPECIES_SPRITE(SLICHIC, gMonFrontPic_Slichic),
    SPECIES_SPRITE(MURDEROO, gMonFrontPic_Murderoo),
    SPECIES_SPRITE(ROBBANK, gMonFrontPic_Robbank),
    SPECIES_SPRITE(CORRIMINAL, gMonFrontPic_Corriminal),
