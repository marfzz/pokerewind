...
const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(PAROPEAT, gMonBackPic_Paropeat),
    SPECIES_SPRITE(MACAUMENT, gMonBackPic_Macaument),
    SPECIES_SPRITE(ARGUWINT, gMonBackPic_Arguwint),
    SPECIES_SPRITE(PRIMATIO, gMonBackPic_Primatio),
    SPECIES_SPRITE(OPINIMP, gMonBackPic_Opinimp),
    SPECIES_SPRITE(TEMPERILLA, gMonBackPic_Temperilla),
    SPECIES_SPRITE(SUBSTEE, gMonBackPic_Substee),
    SPECIES_SPRITE(MANEMBER, gMonBackPic_Manember),
    SPECIES_SPRITE(TRECHIBER, gMonBackPic_Trechiber),
    SPECIES_SPRITE(BULBITE, gMonBackPic_Bulbite),
    SPECIES_SPRITE(LAMPUPA, gMonBackPic_Lampupa),
    SPECIES_SPRITE(ELECREEP, gMonBackPic_Elecreep),
    SPECIES_SPRITE(ACTURUNK, gMonBackPic_Acturunk),
    SPECIES_SPRITE(DRAMASPIRE, gMonBackPic_Dramaspire),
    SPECIES_SPRITE(BURROBIT, gMonBackPic_Burrobit),
    SPECIES_SPRITE(RABBITATE, gMonBackPic_Rabbitate),
    SPECIES_SPRITE(CUCKOOB, gMonBackPic_Cuckoob),
    SPECIES_SPRITE(TWIDDIES, gMonBackPic_Twiddies),
    SPECIES_SPRITE(AIRIOLA, gMonBackPic_Airiola),
    SPECIES_SPRITE(STANDAAD, gMonBackPic_Standaad),
    SPECIES_SPRITE(RECKLOAT, gMonBackPic_Reckloat),
    SPECIES_SPRITE(DEVILOAT, gMonBackPic_Deviloat),
    SPECIES_SPRITE(KITKAR, gMonBackPic_Kitkar),
    SPECIES_SPRITE(CANNEKO, gMonBackPic_Canneko),
    SPECIES_SPRITE(GRUBFEED, gMonBackPic_Grubfeed),
    SPECIES_SPRITE(KWIZBEE, gMonBackPic_Kwizbee),
    SPECIES_SPRITE(COSMONARCH, gMonBackPic_Cosmonarch),
    SPECIES_SPRITE(PAASTEL, gMonBackPic_Paastel),
    SPECIES_SPRITE(SHEEPASTRY, gMonBackPic_Sheepastry),
    SPECIES_SPRITE(PIKASH, gMonBackPic_Pikash),
    SPECIES_SPRITE(SONIKACHU, gMonBackPic_Sonikachu),
    SPECIES_SPRITE(TYPURR, gMonBackPic_Typurr),
    SPECIES_SPRITE(CALIKEY, gMonBackPic_Calikey),
    SPECIES_SPRITE(SPOOKIDS, gMonBackPic_Spookids),
    SPECIES_SPRITE(TOGETERROR, gMonBackPic_Togeterror),
    SPECIES_SPRITE(BUBOZOA, gMonBackPic_Bubozoa),
    SPECIES_SPRITE(CHRYSAPOD, gMonBackPic_Chrysapod),
    SPECIES_SPRITE(ARGIGAMI, gMonBackPic_Argigami),
    SPECIES_SPRITE(DISPUTRAW, gMonBackPic_Disputraw),
    SPECIES_SPRITE(SPIRICK, gMonBackPic_Spirick),
    SPECIES_SPRITE(PLAGHOST, gMonBackPic_Plaghost),
    SPECIES_SPRITE(COVILED, gMonBackPic_Coviled),
    SPECIES_SPRITE(CONTRIP, gMonBackPic_Contrip),
    SPECIES_SPRITE(PLUNGEMENT, gMonBackPic_Plungement),
    SPECIES_SPRITE(ACCIDROP, gMonBackPic_Accidrop),
    SPECIES_SPRITE(CURSWORM, gMonBackPic_Cursworm),
    SPECIES_SPRITE(WINDOWORM, gMonBackPic_Windoworm),
    SPECIES_SPRITE(LOCKSMIAN, gMonBackPic_Locksmian ),
    SPECIES_SPRITE(BINYOTAKE, gMonBackPic_Binyotake),
    SPECIES_SPRITE(SVAMPELETT, gMonBackPic_Svampelett),
    SPECIES_SPRITE(KRABADICT, gMonBackPic_Krabadict),
    SPECIES_SPRITE(KETAGENE, gMonBackPic_Ketagene),
	SPECIES_SPRITE(SHORTS, gMonBackPic_Shorts),
    SPECIES_SPRITE(PANTS, gMonBackPic_Pants),
	SPECIES_SPRITE(CACOBELLE, gMonBackPic_Cacobelle),
    SPECIES_SPRITE(DELPHIER, gMonBackPic_Delphier),
	SPECIES_SPRITE(ENTESAGT, gMonBackPic_Entesagt),
    SPECIES_SPRITE(SKELIPEDE, gMonBackPic_Skelipede),
    SPECIES_SPRITE(COFFINSECT, gMonBackPic_Coffinsect),
    SPECIES_SPRITE(TERRACAL, gMonBackPic_Terracal),
    SPECIES_SPRITE(DIGFLOPPA, gMonBackPic_Digfloppa),
	SPECIES_SPRITE(TELECO, gMonBackPic_Teleco),
    SPECIES_SPRITE(ESAKIT, gMonBackPic_Esakit),
	SPECIES_SPRITE(FOREKAYE, gMonBackPic_Forekaye),
    SPECIES_SPRITE(HELLMO, gMonBackPic_Hellmo),
    SPECIES_SPRITE(RANDOMAIL, gMonBackPic_Randomail),
    SPECIES_SPRITE(DEDLIVERY, gMonBackPic_Dedlivery),
    SPECIES_SPRITE(SIXTEEVY, gMonBackPic_Sixteevy),
    SPECIES_SPRITE(TENEIDEEPI, gMonBackPic_Teneideepi),
    SPECIES_SPRITE(MLADIBUG, gMonBackPic_Mladibug),
    SPECIES_SPRITE(FLEXNAKE, gMonBackPic_Flexnake),
    SPECIES_SPRITE(FLEXAIL, gMonBackPic_Flexail),
    SPECIES_SPRITE(ETIKUB, gMonBackPic_Etikub),
    SPECIES_SPRITE(DESMANTHER, gMonBackPic_Desmanther),
    SPECIES_SPRITE(SUPPORPOD, gMonBackPic_Supporpod),
    SPECIES_SPRITE(FLYPOD, gMonBackPic_Flypod),
    SPECIES_SPRITE(VEESEE, gMonBackPic_Veesee),
    SPECIES_SPRITE(DRACORD, gMonBackPic_Dracord),
    SPECIES_SPRITE(DONKRIME, gMonBackPic_Donkrime),
    SPECIES_SPRITE(MAFIADASS, gMonBackPic_Mafiadass),
    SPECIES_SPRITE(MLGLOB, gMonBackPic_Mlglob),
    SPECIES_SPRITE(BRAIMATE, gMonBackPic_Braimate),
    SPECIES_SPRITE(CREWEBRAL, gMonBackPic_Crewebral),
    SPECIES_SPRITE(IMPVADER, gMonBackPic_Impvader),
    SPECIES_SPRITE(EXTERESSUS, gMonBackPic_Exteressus),
    SPECIES_SPRITE(ALSNOW, gMonBackPic_Alsnow),
    SPECIES_SPRITE(COOLLEM, gMonBackPic_Coollem),
    SPECIES_SPRITE(DARKORPSE, gMonBackPic_Darkorpse),
    SPECIES_SPRITE(FUNNESUS, gMonBackPic_Funnesus),
    SPECIES_SPRITE(PUPYRO, gMonBackPic_Pupyro),
    SPECIES_SPRITE(PYRULPES, gMonBackPic_Pyrulpes),
    SPECIES_SPRITE(KITSINICAL, gMonBackPic_Kitsinical),
    SPECIES_SPRITE(COMMUNYMPH, gMonBackPic_Communymph),
    SPECIES_SPRITE(MANTIFA, gMonBackPic_Mantifa),
    SPECIES_SPRITE(HATCHAAL, gMonBackPic_Hatchaal),
    SPECIES_SPRITE(CRUSYGLE, gMonBackPic_Crusygle),
    SPECIES_SPRITE(BUBBABE, gMonBackPic_Bubbabe),
    SPECIES_SPRITE(BUBBATH, gMonBackPic_Bubbath),
    SPECIES_SPRITE(BUBBLUST, gMonBackPic_Bubblust),
    SPECIES_SPRITE(CHANELING, gMonBackPic_Chaneling),
    SPECIES_SPRITE(TROLLMODEL, gMonBackPic_Trollmodel),
    SPECIES_SPRITE(SKORCHOP, gMonBackPic_Skorchop),
    SPECIES_SPRITE(CUBEAST, gMonBackPic_Cubeast),
    SPECIES_SPRITE(BEASTUNT, gMonBackPic_Beastunt),
    SPECIES_SPRITE(HOOTUBE, gMonBackPic_Hootube),
    SPECIES_SPRITE(CHANNOWL, gMonBackPic_Channowl),
    SPECIES_SPRITE(BROYALTY, gMonBackPic_Broyalty),
    SPECIES_SPRITE(FANDAM, gMonBackPic_Fandam),
    ...
    SPECIES_SPRITE(MUSTELIT, gMonBackPic_Mustelit),
    SPECIES_SPRITE(CAPENSEAR, gMonBackPic_Capensear),
    SPECIES_SPRITE(MAPIG, gMonBackPic_Mapig),
    SPECIES_SPRITE(PREDATOAR, gMonBackPic_Predatoar),
    SPECIES_SPRITE(ILLUMARYD, gMonBackPic_Illumaryd),
    SPECIES_SPRITE(ENLIMINATI, gMonBackPic_Enliminati),
    SPECIES_SPRITE(ASTLEYROID, gMonBackPic_Astleyroid),
    SPECIES_SPRITE(POSTLE, gMonBackPic_Postle),
    SPECIES_SPRITE(HUSHBACK, gMonBackPic_Hushback),
    SPECIES_SPRITE(SLICHIC, gMonBackPic_Slichic),
    SPECIES_SPRITE(MURDEROO, gMonBackPic_Murderoo),
    SPECIES_SPRITE(ROBBANK, gMonBackPic_Robbank),
    SPECIES_SPRITE(CORRIMINAL, gMonBackPic_Corriminal),
    SPECIES_SPRITE(VEGAVA, gMonBackPic_Vegava),
    SPECIES_SPRITE(GLUTTOCADO, gMonBackPic_Gluttocado),
    SPECIES_SPRITE(PLAYSTRIKE, gMonBackPic_Playstrike),
    SPECIES_SPRITE(EXBULK, gMonBackPic_Exbulk),
    SPECIES_SPRITE(TOUCHSPEED, gMonBackPic_Touchspeed),
    SPECIES_SPRITE(ZOUNO, gMonBackPic_Zouno),
    SPECIES_SPRITE(PHANESIS, gMonBackPic_Phanesis),
    SPECIES_SPRITE(BIOSSIL, gMonBackPic_Biossil),
    SPECIES_SPRITE(VIRANCIENT, gMonBackPic_Virancient),
    SPECIES_SPRITE(EVECHO, gMonBackPic_Evecho),
    SPECIES_SPRITE(BARSONIST, gMonBackPic_Barsonist),
    SPECIES_SPRITE(CHIPCHUNE, gMonBackPic_Chipchune),
    SPECIES_SPRITE(ORCLASSTRA, gMonBackPic_Orclasstra),
    SPECIES_SPRITE(RELAQUA, gMonBackPic_Relaqua),
    SPECIES_SPRITE(SQUEANIME, gMonBackPic_Squeanime),
    SPECIES_SPRITE(ENIGMASH, gMonBackPic_Enigmash),
    SPECIES_SPRITE(AIRPODON, gMonBackPic_Airpodon),
    SPECIES_SPRITE(MIKOMODO, gMonBackPic_Mikomodo),
    SPECIES_SPRITE(GOJIREC, gMonBackPic_Gojirec),
    SPECIES_SPRITE(EEKORONE, gMonBackPic_Eekorone),
    SPECIES_SPRITE(HALFIST, gMonBackPic_Halfist),
    SPECIES_SPRITE(INEVITON, gMonBackPic_Ineviton),
    ...
    SPECIES_SPRITE(DISPUTRAW_SPECIAL, gMonBackPic_DisputrawSpecial),
