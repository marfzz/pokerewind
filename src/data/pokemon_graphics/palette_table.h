...
const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(PAROPEAT, gMonPalette_Paropeat),
    SPECIES_PAL(MACAUMENT, gMonPalette_Macaument),
    SPECIES_PAL(ARGUWINT, gMonPalette_Arguwint),
    SPECIES_PAL(PRIMATIO, gMonPalette_Primatio),
    SPECIES_PAL(OPINIMP, gMonPalette_Opinimp),
    SPECIES_PAL(TEMPERILLA, gMonPalette_Temperilla),
    SPECIES_PAL(SUBSTEE, gMonPalette_Substee),
    SPECIES_PAL(MANEMBER, gMonPalette_Manember),
    SPECIES_PAL(TRECHIBER, gMonPalette_Trechiber),
    SPECIES_PAL(BULBITE, gMonPalette_Bulbite),
    SPECIES_PAL(LAMPUPA, gMonPalette_Lampupa),
    SPECIES_PAL(ELECREEP, gMonPalette_Elecreep),
    ...
    SPECIES_PAL(STANDAAD, gMonPalette_Standaad),
    SPECIES_PAL(RECKLOAT, gMonPalette_Reckloat),
    SPECIES_PAL(DEVILOAT, gMonPalette_Deviloat),
    SPECIES_PAL(KITKAR, gMonPalette_Kitkar),
    SPECIES_PAL(CANNEKO, gMonPalette_Canneko),
    SPECIES_PAL(GRUBFEED, gMonPalette_Grubfeed),
    SPECIES_PAL(KWIZBEE, gMonPalette_Kwizbee),
    SPECIES_PAL(COSMONARCH, gMonPalette_Cosmonarch),
    SPECIES_PAL(PAASTEL, gMonPalette_Paastel),
    SPECIES_PAL(SHEEPASTRY, gMonPalette_Sheepastry),
    SPECIES_PAL(PIKASH, gMonPalette_Pikash),
    SPECIES_PAL(SONIKACHU, gMonPalette_Sonikachu),
    SPECIES_PAL(TYPURR, gMonPalette_Typurr),
    ...
    SPECIES_PAL(ETIKUB, gMonPalette_Etikub),
    SPECIES_PAL(DESMANTHER, gMonPalette_Desmanther),
    SPECIES_PAL(SUPPORPOD, gMonPalette_Supporpod),
    SPECIES_PAL(FLYPOD, gMonPalette_Flypod),
    SPECIES_PAL(VEESEE, gMonPalette_Veesee),
    SPECIES_PAL(DRACORD, gMonPalette_Dracord),
    SPECIES_PAL(DONKRIME, gMonPalette_Donkrime),
    SPECIES_PAL(MAFIADASS, gMonPalette_Mafiadass),
    SPECIES_PAL(MLGLOB, gMonPalette_Mlglob),
    SPECIES_PAL(BRAIMATE, gMonPalette_Braimate),
    SPECIES_PAL(CREWEBRAL, gMonPalette_Crewebral),
    SPECIES_PAL(IMPVADER, gMonPalette_Impvader),
    SPECIES_PAL(EXTERESSUS, gMonPalette_Exteressus),
    SPECIES_PAL(ALSNOW, gMonPalette_Alsnow),
    SPECIES_PAL(COOLLEM, gMonPalette_Coollem),
    SPECIES_PAL(DARKORPSE, gMonPalette_Darkorpse),
    SPECIES_PAL(FUNNESUS, gMonPalette_Funnesus),
    SPECIES_PAL(PUPYRO, gMonPalette_Pupyro),
    SPECIES_PAL(PYRULPES, gMonPalette_Pyrulpes),
    SPECIES_PAL(KITSINICAL, gMonPalette_Kitsinical),
    SPECIES_PAL(COMMUNYMPH, gMonPalette_Communymph),
    SPECIES_PAL(MANTIFA, gMonPalette_Mantifa),
    SPECIES_PAL(HATCHAAL, gMonPalette_Hatchaal),
    SPECIES_PAL(CRUSYGLE, gMonPalette_Crusygle),
    SPECIES_PAL(BUBBABE, gMonPalette_Bubbabe),
    SPECIES_PAL(BUBBATH, gMonPalette_Bubbath),
    SPECIES_PAL(BUBBLUST, gMonPalette_Bubblust),
    SPECIES_PAL(CHANELING, gMonPalette_Chaneling),
    SPECIES_PAL(TROLLMODEL, gMonPalette_Trollmodel),
    SPECIES_PAL(SKORCHOP, gMonPalette_Skorchop),
    SPECIES_PAL(CUBEAST, gMonPalette_Cubeast),
    SPECIES_PAL(BEASTUNT, gMonPalette_Beastunt),
    SPECIES_PAL(HOOTUBE, gMonPalette_Hootube),
    SPECIES_PAL(CHANNOWL, gMonPalette_Channowl),
    SPECIES_PAL(BROYALTY, gMonPalette_Broyalty),
    SPECIES_PAL(FANDAM, gMonPalette_Fandam),
    ...
    SPECIES_PAL(MUSTELIT, gMonPalette_Mustelit),
    SPECIES_PAL(CAPENSEAR, gMonPalette_Capensear),
    SPECIES_PAL(MAPIG, gMonPalette_Mapig),
    SPECIES_PAL(PREDATOAR, gMonPalette_Predatoar),
    SPECIES_PAL(ILLUMARYD, gMonPalette_Illumaryd),
    SPECIES_PAL(ENLIMINATI, gMonPalette_Enliminati),
    SPECIES_PAL(ASTLEYROID, gMonPalette_Astleyroid),
    SPECIES_PAL(POSTLE, gMonPalette_Postle),
    SPECIES_PAL(HUSHBACK, gMonPalette_Hushback),
    SPECIES_PAL(SLICHIC, gMonPalette_Slichic),
    SPECIES_PAL(MURDEROO, gMonPalette_Murderoo),
    SPECIES_PAL(ROBBANK, gMonPalette_Robbank),
    SPECIES_PAL(CORRIMINAL, gMonPalette_Corriminal),
    SPECIES_PAL(VEGAVA, gMonPalette_Vegava),
    SPECIES_PAL(GLUTTOCADO, gMonPalette_Gluttocado),
    SPECIES_PAL(PLAYSTRIKE, gMonPalette_Playstrike),
    SPECIES_PAL(EXBULK, gMonPalette_Exbulk),
    SPECIES_PAL(TOUCHSPEED, gMonPalette_Touchspeed),
    SPECIES_PAL(ZOUNO, gMonPalette_Zouno),
    SPECIES_PAL(PHANESIS, gMonPalette_Phanesis),
    SPECIES_PAL(BIOSSIL, gMonPalette_Biossil),
    SPECIES_PAL(VIRANCIENT, gMonPalette_Virancient),
    SPECIES_PAL(EVECHO, gMonPalette_Evecho),
    SPECIES_PAL(BARSONIST, gMonPalette_Barsonist),
    SPECIES_PAL(CHIPCHUNE, gMonPalette_Chipchune),
    SPECIES_PAL(ORCLASSTRA, gMonPalette_Orclasstra),
    SPECIES_PAL(RELAQUA, gMonPalette_Relaqua),
    SPECIES_PAL(SQUEANIME, gMonPalette_Squeanime),
    SPECIES_PAL(ENIGMASH, gMonPalette_Enigmash),
    SPECIES_PAL(AIRPODON, gMonPalette_Airpodon),
...
SPECIES_PAL(CRAMORANT_GULPING, gMonPalette_CramorantGulping),
    ...
    SPECIES_PAL(DISPUTRAW_SPECIAL, gMonPalette_DisputrawSpecial),
