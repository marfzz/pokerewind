...
{
    [SPECIES_NONE] = sParopeatLevelUpLearnset,
    [SPECIES_PAROPEAT] = sParopeatLevelUpLearnset,
    [SPECIES_MACAUMENT] = sMacaumentLevelUpLearnset,
    [SPECIES_ARGUWINT] = sArguwintLevelUpLearnset,
    [SPECIES_PRIMATIO] = sPrimatioLevelUpLearnset,
    [SPECIES_OPINIMP] = sOpinimpLevelUpLearnset,
    [SPECIES_TEMPERILLA] = sTemperillaLevelUpLearnset,
    [SPECIES_SUBSTEE] = sSubsteeLevelUpLearnset,
    [SPECIES_MANEMBER] = sManemberLevelUpLearnset,
    [SPECIES_TRECHIBER] = sTrechiberLevelUpLearnset,
    [SPECIES_BULBITE] = sBulbiteLevelUpLearnset,
    [SPECIES_LAMPUPA] = sLampupaLevelUpLearnset,
    [SPECIES_ELECREEP] = sElecreepLevelUpLearnset,
    [SPECIES_ACTURUNK] = sActurunkLevelUpLearnset,
    [SPECIES_DRAMASPIRE] = sDramaspireLevelUpLearnset,
    [SPECIES_BURROBIT] = sBurrobitLevelUpLearnset,
    [SPECIES_RABBITATE] = sRabbitateLevelUpLearnset,
    [SPECIES_CUCKOOB] = sCuckoobLevelUpLearnset,
    [SPECIES_TWIDDIES] = sTwiddiesLevelUpLearnset,
    [SPECIES_AIRIOLA] = sAiriolaLevelUpLearnset,
    [SPECIES_STANDAAD] = sStandaadLevelUpLearnset,
    [SPECIES_RECKLOAT] = sReckloatLevelUpLearnset,
    [SPECIES_DEVILOAT] = sDeviloatLevelUpLearnset,
    [SPECIES_KITKAR] = sKitkarLevelUpLearnset,
    [SPECIES_CANNEKO] = sCannekoLevelUpLearnset,
    [SPECIES_PIKASH] = sPikashLevelUpLearnset,
    [SPECIES_SONIKACHU] = sSonikachuLevelUpLearnset,
    [SPECIES_GRUBFEED] = sGrubfeedLevelUpLearnset,
    [SPECIES_KWIZBEE] = sKwizbeeLevelUpLearnset,
    [SPECIES_COSMONARCH] = sCosmonarchLevelUpLearnset,
    [SPECIES_PAASTEL] = sPaastelLevelUpLearnset,
    [SPECIES_SHEEPASTRY] = sSheepastryLevelUpLearnset,
    [SPECIES_TYPURR] = sTypurrLevelUpLearnset,
    [SPECIES_CALIKEY] = sCalikeyLevelUpLearnset,
    [SPECIES_SPOOKIDS] = sSpookidsLevelUpLearnset,
    [SPECIES_TOGETERROR] = sTogeterrorLevelUpLearnset,
    [SPECIES_BUBOZOA] = sBubozoaLevelUpLearnset,
    [SPECIES_CHRYSAPOD] = sChrysapodLevelUpLearnset,
    [SPECIES_ARGIGAMI] = sArgigamiLevelUpLearnset,
    [SPECIES_DISPUTRAW] = sDisputrawLevelUpLearnset,
    [SPECIES_DISPUTRAW_SPECIAL] = sDisputrawLevelUpLearnset,
    [SPECIES_SPIRICK] = sSpirickLevelUpLearnset,
    [SPECIES_PLAGHOST] = sPlaghostLevelUpLearnset,
    [SPECIES_COVILED] = sCoviledLevelUpLearnset,
    [SPECIES_CONTRIP] = sContripLevelUpLearnset,
    [SPECIES_PLUNGEMENT] = sPlungementLevelUpLearnset,
    [SPECIES_ACCIDROP] = sAccidropLevelUpLearnset,
    [SPECIES_CURSWORM] = sCurswormLevelUpLearnset,
    [SPECIES_WINDOWORM] = sWindowormLevelUpLearnset,
    [SPECIES_LOCKSMIAN] = sLocksmianLevelUpLearnset,
    [SPECIES_BINYOTAKE] = sBinyotakeLevelUpLearnset,
    [SPECIES_SVAMPELETT] = sSvampelettLevelUpLearnset,
	[SPECIES_KRABADICT] = sKrabadictLevelUpLearnset,
	[SPECIES_KETAGENE] = sKetageneLevelUpLearnset,
	[SPECIES_SHORTS] = sShortsLevelUpLearnset,
	[SPECIES_PANTS] = sPantsLevelUpLearnset,
	[SPECIES_CACOBELLE] = sCacobelleLevelUpLearnset,
	[SPECIES_DELPHIER] = sDelphierLevelUpLearnset,
	[SPECIES_ENTESAGT] = sEntesagtLevelUpLearnset,
	[SPECIES_SKELIPEDE] = sSkelipedeLevelUpLearnset,
	[SPECIES_COFFINSECT] = sCoffinsectLevelUpLearnset,
	[SPECIES_TERRACAL] = sTerracalLevelUpLearnset,
	[SPECIES_DIGFLOPPA] = sDigfloppaLevelUpLearnset,
	[SPECIES_TELECO] = sTelecoLevelUpLearnset,
	[SPECIES_ESAKIT] = sEsakitLevelUpLearnset,
	[SPECIES_FOREKAYE] = sForekayeLevelUpLearnset,
	[SPECIES_HELLMO] = sHellmoLevelUpLearnset,
    ...
    [SPECIES_HALFIST] = sHalfistLevelUpLearnset,
    [SPECIES_INEVITON] = sInevitonLevelUpLearnset,
    ...
    // Megas
    [SPECIES_VENUSAUR_MEGA] = sArguwintLevelUpLearnset,
    [SPECIES_CHARIZARD_MEGA_X] = sTemperillaLevelUpLearnset,
    [SPECIES_CHARIZARD_MEGA_Y] = sTemperillaLevelUpLearnset,
    [SPECIES_BLASTOISE_MEGA] = sTrechiberLevelUpLearnset,
    [SPECIES_BEEDRILL_MEGA] = sBurrobitLevelUpLearnset,
    [SPECIES_PIDGEOT_MEGA] = sTwiddiesLevelUpLearnset,
    ...
    // Misc Forms
    // Cosplay Pikachu
    [SPECIES_PIKACHU_COSPLAY] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_ROCK_STAR] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_BELLE] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_POP_STAR] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_PH_D] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_LIBRE] = sPikashLevelUpLearnset,
    // Cap Pikachu
    [SPECIES_PIKACHU_ORIGINAL_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_HOENN_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_SINNOH_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_UNOVA_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_KALOS_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_ALOLA_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_PARTNER_CAP] = sPikashLevelUpLearnset,
    [SPECIES_PIKACHU_WORLD_CAP] = sPikashLevelUpLearnset,
    // Pichu
