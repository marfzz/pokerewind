...
{
    [SPECIES_PAROPEAT]              = {{EVO_LEVEL, 16, SPECIES_MACAUMENT}},
    [SPECIES_MACAUMENT]             = {{EVO_LEVEL, 36, SPECIES_ARGUWINT}},
    //[SPECIES_VENUSAUR]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA}},
    [SPECIES_PRIMATIO]              = {{EVO_LEVEL, 16, SPECIES_OPINIMP}},
    [SPECIES_OPINIMP]               = {{EVO_LEVEL, 36, SPECIES_TEMPERILLA}},
    ...
    [SPECIES_SUBSTEE]               = {{ EVO_LEVEL, 16, SPECIES_MANEMBER}},
    [SPECIES_MANEMBER]              = {{ EVO_LEVEL, 36, SPECIES_TRECHIBER}},
    ...
    [SPECIES_LAMPUPA]               = {{EVO_LEVEL, 35, SPECIES_ELECREEP}},
    [SPECIES_ACTURUNK]              = {{EVO_LEVEL, 16, SPECIES_DRAMASPIRE}},
    [SPECIES_BURROBIT]              = {{EVO_LEVEL, 25, SPECIES_RABBITATE}},
    //[SPECIES_BEEDRILL]              = {{EVO_MEGA_EVOLUTION, ITEM_BEEDRILLITE, SPECIES_BEEDRILL_MEGA}},
    [SPECIES_CUCKOOB]               = {{EVO_LEVEL, 20, SPECIES_TWIDDIES}},
    [SPECIES_TWIDDIES]              = {{EVO_LEVEL, 42, SPECIES_AIRIOLA}},
    [SPECIES_STANDAAD]              = {{EVO_LEVEL_DAY, 30, SPECIES_RECKLOAT},
                                       {EVO_LEVEL_NIGHT, 30, SPECIES_DEVILOAT}},
    [SPECIES_KITKAR]                = {{EVO_LEVEL, 40, SPECIES_CANNEKO}},
    [SPECIES_PIKASH]                = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_SONIKACHU}},
    [SPECIES_GRUBFEED]              = {{EVO_LEVEL, 17, SPECIES_KWIZBEE}},
    [SPECIES_KWIZBEE]               = {{EVO_LEVEL_FEMALE, 32 , SPECIES_COSMONARCH}},
    [SPECIES_PAASTEL]               = {{EVO_FRIENDSHIP, 0, SPECIES_SHEEPASTRY}},
    [SPECIES_TYPURR]                = {{EVO_LEVEL, 20, SPECIES_CALIKEY}},
    [SPECIES_SPOOKIDS]              = {{EVO_LEVEL, 37, SPECIES_TOGETERROR}},
    [SPECIES_BUBOZOA]              = {{EVO_LEVEL, 28, SPECIES_CHRYSAPOD}},
    [SPECIES_ARGIGAMI]              = {{EVO_LEVEL, 22, SPECIES_DISPUTRAW}},
    [SPECIES_SPIRICK]               = {{EVO_LEVEL, 27, SPECIES_PLAGHOST}},
    [SPECIES_PLAGHOST]              = {{EVO_LEVEL, 46, SPECIES_COVILED}},
    [SPECIES_CONTRIP]                = {{EVO_LEVEL, 15, SPECIES_PLUNGEMENT}},
    [SPECIES_PLUNGEMENT]            = {{EVO_LEVEL, 26, SPECIES_ACCIDROP}},
    [SPECIES_CURSWORM]              = {{EVO_LEVEL, 32, SPECIES_WINDOWORM}},
    [SPECIES_BINYOTAKE]             = {{EVO_MOVE, MOVE_LEECH_SEED, SPECIES_SVAMPELETT}},
	[SPECIES_KRABADICT]				= {{EVO_ITEM, ITEM_X_SPEED, SPECIES_KETAGENE}},
    [SPECIES_RANDOMAIL]             = {{EVO_LEVEL, 19, SPECIES_DEDLIVERY}},
    [SPECIES_SKELIPEDE]             = {{ EVO_LEVEL, 22, SPECIES_COFFINSECT}},
	[SPECIES_TERRACAL] 				= {{ EVO_LEVEL,26, SPECIES_DIGFLOPPA}},
	[SPECIES_TELECO] 				= {{ EVO_LEVEL, 18, SPECIES_ESAKIT}},
	[SPECIES_ESAKIT] 				= {{ EVO_LEVEL, 38, SPECIES_FOREKAYE}},
    //[SPECIES_ALAKAZAM]              = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    [SPECIES_FLEXNAKE]              = {{ EVO_LEVEL, 42, SPECIES_FLEXAIL}},
    [SPECIES_ETIKUB]                = {{ EVO_LEVEL, 35, SPECIES_DESMANTHER}},
    [SPECIES_SUPPORPOD]             = {{ EVO_LEVEL, 31, SPECIES_FLYPOD}},
    [SPECIES_VEESEE]                = {{ EVO_LEVEL, 35, SPECIES_DRACORD}},
    [SPECIES_DONKRIME]              = {{ EVO_LEVEL, 36, SPECIES_MAFIADASS}},
    [SPECIES_BRAIMATE]              = {{ EVO_LEVEL, 31, SPECIES_CREWEBRAL}},
    [SPECIES_IMPVADER]              = {{ EVO_LEVEL, 31, SPECIES_EXTERESSUS}},
    [SPECIES_ALSNOW]                = {{ EVO_ITEM, ITEM_ICE_STONE, SPECIES_COOLLEM}},
    [SPECIES_PUPYRO]                = {{ EVO_LEVEL, 33, SPECIES_PYRULPES}},
    [SPECIES_PYRULPES]              = {{ EVO_LEVEL, 44, SPECIES_KITSINICAL}},
    [SPECIES_COMMUNYMPH]            = {{ EVO_FRIENDSHIP, 0, SPECIES_MANTIFA}},
    [SPECIES_BUBBABE]               = {{ EVO_LEVEL, 30, SPECIES_BUBBATH}},
    [SPECIES_BUBBATH]               = {{ EVO_ITEM, ITEM_WATER_STONE, SPECIES_BUBBLUST}},
   // [SPECIES_CHANELING]             = {{ EVO_LEVEL, 32, SPECIES_TROLLMODEL}},
    [SPECIES_HOOTUBE]               = {{ EVO_LEVEL, 45, SPECIES_CHANNOWL}},
    [SPECIES_BROYALTY]              = {{ EVO_ITEM, ITEM_METAL_COAT, SPECIES_FANDAM}},
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_MUSTELIT]              = {{ EVO_LEVEL, 39, SPECIES_CAPENSEAR}},
  //  [SPECIES_MAPIG]                 = {{ EVO_LEVEL, 37, SPECIES_PREDATOAR}},
    [SPECIES_ILLUMARYD]             = {{ EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ENLIMINATI}},
    [SPECIES_POSTLE]                = {{ EVO_LEVEL, 35, SPECIES_HUSHBACK}},
 //   [SPECIES_SLICHIC]               = {{ EVO_LEVEL, 35, SPECIES_MURDEROO}},
 //   [SPECIES_ROBBANK]               = {{ EVO_LEVEL_NIGHT, 36, SPECIES_CORRIMINAL}},
    [SPECIES_VEGAVA]                = {{ EVO_ITEM, ITEM_LEAF_STONE, SPECIES_GLUTTOCADO}},
    [SPECIES_ZOUNO]                 = {{ EVO_LEVEL, 40, SPECIES_PHANESIS}},
    [SPECIES_BIOSSIL]               = {{ EVO_LEVEL, 40, SPECIES_VIRANCIENT}},
    [SPECIES_EVECHO]                = {{EVO_LEVEL_HIGH_ATK, 30, SPECIES_BARSONIST},
                                       {EVO_LEVEL_HIGH_DEF, 30, SPECIES_CHIPCHUNE},
                                       {EVO_LEVEL_HIGH_SPATK, 30, SPECIES_ORCLASSTRA},
                                       {EVO_LEVEL_HIGH_SPDEF, 30, SPECIES_RELAQUA},
                                       {EVO_LEVEL_HIGH_SPEED, 30, SPECIES_SQUEANIME},
                                       {EVO_MOVE, MOVE_MIMIC, SPECIES_ENIGMASH}},
    [SPECIES_AIRPODON]              = {{ EVO_LEVEL, 30, SPECIES_MIKOMODO}},
    [SPECIES_MIKOMODO]              = {{ EVO_LEVEL, 55, SPECIES_GOJIREC}},
	[SPECIES_HALFIST]				= {{EVO_ITEM,ITEM_MOON_STONE}},
