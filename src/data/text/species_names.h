const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_PAROPEAT] = _("Paropeat"),
    [SPECIES_MACAUMENT] = _("Macaument"),
    [SPECIES_ARGUWINT] = _("Arguwint"),
    [SPECIES_PRIMATIO] = _("Primatio"),
    [SPECIES_OPINIMP] = _("Opinimp"),
    [SPECIES_TEMPERILLA] = _("Temperilla"),
    [SPECIES_SUBSTEE] = _("Substee"),
    [SPECIES_MANEMBER] = _("Manember"),
    [SPECIES_TRECHIBER] = _("Trechiber"),
    [SPECIES_BULBITE] = _("Bulbite"),
    [SPECIES_LAMPUPA] = _("Lampupa"),
    [SPECIES_ELECREEP] = _("Elecreep"),
    [SPECIES_ACTURUNK] = _("Acturunk"),
    [SPECIES_DRAMASPIRE] = _("Dramaspire"),
    [SPECIES_BURROBIT] = _("Burrobit"),
    [SPECIES_RABBITATE] = _("Rabbitate"),
    [SPECIES_CUCKOOB] = _("Cuckoob"),
    [SPECIES_TWIDDIES] = _("Twiddies"),
    [SPECIES_AIRIOLA] = _("Airiola"),
    [SPECIES_STANDAAD] = _("Standaad"),
    [SPECIES_RECKLOAT] = _("Reckloat"),
    [SPECIES_DEVILOAT] = _("Deviloat"),
    [SPECIES_KITKAR] = _("Kitkar"),
    [SPECIES_CANNEKO] = _("Canneko"),
    [SPECIES_PIKASH] = _("Pikash"),
    [SPECIES_SONIKACHU] = _("Sonikachu"),
    [SPECIES_GRUBFEED] = _("Grubfeed"),
    [SPECIES_KWIZBEE] = _("Kwizbee"),
    [SPECIES_COSMONARCH] = _("Cosmonarch"),
    [SPECIES_PAASTEL] = _("Paastel"),
    [SPECIES_SHEEPASTRY] = _("Sheepastry"),
    [SPECIES_TYPURR] = _("Typurr"),
    [SPECIES_CALIKEY] = _("Calikey"),
    [SPECIES_SPOOKIDS] = _("Spookids"),
    [SPECIES_TOGETERROR] = _("Togeterror"),
    [SPECIES_BUBOZOA] = _("Bubozoa"),
    [SPECIES_CHRYSAPOD] = _("Chrysapod"),
    [SPECIES_ARGIGAMI] = _("Argigami"),
    [SPECIES_DISPUTRAW] = _("Disputraw"),
    [SPECIES_DISPUTRAW_SPECIAL] = _("Disputraw"),
    [SPECIES_SPIRICK] = _("Spirick"),
    [SPECIES_PLAGHOST] = _("Plaghost"),
    [SPECIES_COVILED] = _("Coviled"),
    [SPECIES_CONTRIP] = _("Contrip"),
    [SPECIES_PLUNGEMENT] = _("Plungement"),
    [SPECIES_ACCIDROP] = _("Accidrop"),
    [SPECIES_CURSWORM] = _("Cursworm"),
    [SPECIES_WINDOWORM] = _("Windoworm"),
    [SPECIES_LOCKSMIAN] = _("Locksmian"),
    [SPECIES_BINYOTAKE] = _("Binyotake"),
    [SPECIES_SVAMPELETT] = _("Svampelett"),
    [SPECIES_KRABADICT] = _("Krabadict"),
	[SPECIES_KETAGENE] = _("Ketagene"),
	[SPECIES_SHORTS] = _("Shorts"),
	[SPECIES_PANTS] = _("Pants"),
	[SPECIES_CACOBELLE] = _("Cacobelle"),
	[SPECIES_DELPHIER] = _("Delphier"),
	[SPECIES_ENTESAGT] = _("Entesagt"),
	[SPECIES_SKELIPEDE] = _("Skelipede"),
    [SPECIES_COFFINSECT] = _("Coffinsect"),
    [SPECIES_TERRACAL] = _("Terracal"),
    [SPECIES_DIGFLOPPA] = _("Digfloppa"),
	[SPECIES_TELECO] = _("Teleco"),
	[SPECIES_ESAKIT] = _("Esakit"),
	[SPECIES_FOREKAYE] = _("Forekaye"),
	[SPECIES_HELLMO] = _("Hellmo"),
    [SPECIES_RANDOMAIL] = _("Randomail"),
    [SPECIES_DEDLIVERY] = _("Dedlivery"),
    [SPECIES_SIXTEEVY] = _("Sixteevy"),
    [SPECIES_TENEIDEEPI] = _("Teneideepi"),
    [SPECIES_MLADIBUG] = _("M'ladibug"),
    [SPECIES_FLEXNAKE] = _("Flexnake"),
    [SPECIES_FLEXAIL] = _("Flexail"),
    [SPECIES_ETIKUB] = _("Etikub"),
    [SPECIES_DESMANTHER] = _("Desmanther"),
    [SPECIES_SUPPORPOD] = _("Supporpod"),
    [SPECIES_FLYPOD] = _("Flypod"),
    [SPECIES_VEESEE] = _("Veesee"),
    [SPECIES_DRACORD] = _("Dracord"),
    [SPECIES_DONKRIME] = _("Donkrime"),
    [SPECIES_MAFIADASS] = _("Mafiadass"),
    [SPECIES_MLGLOB] = _("Mlglob"),
    [SPECIES_BRAIMATE] = _("Braimate"),
    [SPECIES_CREWEBRAL] = _("Crewebral"),
    [SPECIES_IMPVADER] = _("Impvader"),
    [SPECIES_EXTERESSUS] = _("Exteressus"),
    [SPECIES_ALSNOW] = _("Alsnow"),
    [SPECIES_COOLLEM] = _("Coollem"),
    [SPECIES_DARKORPSE] = _("Darkorpse"),
    [SPECIES_FUNNESUS] = _("Funnesus"),
    [SPECIES_PUPYRO] = _("Pupyro"),
    [SPECIES_PYRULPES] = _("Pyrulpes"),
    [SPECIES_KITSINICAL] = _("Kitsinical"),
    [SPECIES_COMMUNYMPH] = _("Communymph"),
    [SPECIES_MANTIFA] = _("Mantifa"),
    [SPECIES_HATCHAAL] = _("Hatchaal"),
    [SPECIES_CRUSYGLE] = _("Crusygle"),
    [SPECIES_BUBBABE] = _("Bubbabe"),
    [SPECIES_BUBBATH] = _("Bubbath"),
    [SPECIES_BUBBLUST] = _("Bubblust"),
    [SPECIES_CHANELING] = _("Chaneling"),
    [SPECIES_TROLLMODEL] = _("Trollmodel"),
    [SPECIES_SKORCHOP] = _("Skorchop"),
    [SPECIES_CUBEAST] = _("Cubeast"),
    [SPECIES_BEASTUNT] = _("Beastunt"),
    [SPECIES_HOOTUBE] = _("Hootube"),
    [SPECIES_CHANNOWL] = _("Channowl"),
    [SPECIES_BROYALTY] = _("Broyalty"),
    [SPECIES_FANDAM] = _("Fandam"),
    ...
    [SPECIES_MUSTELIT] = _("Mustelit"),
    [SPECIES_CAPENSEAR] = _("Capensear"),
    [SPECIES_MAPIG] = _("Mapig"),
    [SPECIES_PREDATOAR] = _("Predatoar"),
    [SPECIES_ILLUMARYD] = _("Illumaryd"),
    [SPECIES_ENLIMINATI] = _("Enliminati"),
    [SPECIES_ASTLEYROID] = _("Astleyroid"),
    [SPECIES_POSTLE] = _("Postle"),
    [SPECIES_HUSHBACK] = _("Hushback"),
    [SPECIES_SLICHIC] = _("Slichic"),
    [SPECIES_MURDEROO] = _("Murderoo"),
    [SPECIES_ROBBANK] = _("Robbank"),
    [SPECIES_CORRIMINAL] = _("Corriminal"),
    [SPECIES_VEGAVA] = _("Vegava"),
    [SPECIES_GLUTTOCADO] = _("Gluttocado"),
    [SPECIES_PLAYSTRIKE] = _("Playstrike"),
    [SPECIES_EXBULK] = _("Exbulk"),
    [SPECIES_TOUCHSPEED] = _("Touchspeed"),
    [SPECIES_ZOUNO] = _("Zouno"),
    [SPECIES_PHANESIS] = _("Phanesis"),
    [SPECIES_BIOSSIL] = _("Biossil"),
    [SPECIES_VIRANCIENT] = _("Virancient"),
    [SPECIES_EVECHO] = _("Evecho"),
    [SPECIES_BARSONIST] = _("Barsonist"),
    [SPECIES_CHIPCHUNE] = _("Chipchune"),
    [SPECIES_ORCLASSTRA] = _("Orclasstra"),
    [SPECIES_RELAQUA] = _("Relaqua"),
    [SPECIES_SQUEANIME] = _("Squeanime"),
    [SPECIES_ENIGMASH] = _("Enigmash"),
    [SPECIES_AIRPODON] = _("Airpodon"),
    [SPECIES_MIKOMODO] = _("Mikomodo"),
    [SPECIES_GOJIREC] = _("Gojirec"),
    [SPECIES_EEKORONE] = _("Eekorone"),
    [SPECIES_HALFIST] = _("Halfist"),
    [SPECIES_INEVITON] = _("Ineviton"),
