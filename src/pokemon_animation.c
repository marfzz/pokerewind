...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_CONTRIP] = BACK_ANIM_H_SLIDE,
    [SPECIES_PLUNGEMENT] = BACK_ANIM_H_SLIDE,
    [SPECIES_ACCIDROP] = BACK_ANIM_SHRINK_GROW_2,
	...
	[SPECIES_DUGTRIO] = BACK_ANIM_VERTICAL_STRETCH,
    [SPECIES_KRABADICT] = BACK_ANIM_VERTICAL_SHAKE,
