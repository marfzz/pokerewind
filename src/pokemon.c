...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(BUBOZOA),
    SPECIES_TO_NATIONAL(CHRYSAPOD),
    ...
    SPECIES_TO_NATIONAL(CONTRIP),
    SPECIES_TO_NATIONAL(PLUNGEMENT),
    SPECIES_TO_NATIONAL(ACCIDROP),
    SPECIES_TO_NATIONAL(CURSWORM),
    SPECIES_TO_NATIONAL(WINDOWORM),
    SPECIES_TO_NATIONAL(LOCKSMIAN),
    SPECIES_TO_NATIONAL(BINYOTAKE),
    SPECIES_TO_NATIONAL(SVAMPELETT),
    SPECIES_TO_NATIONAL(KRABADICT),
    SPECIES_TO_NATIONAL(KETAGENE),
    SPECIES_TO_NATIONAL(SHORTS),
    ...
    SPECIES_TO_NATIONAL(TELECO),
    SPECIES_TO_NATIONAL(ESAKIT),
    SPECIES_TO_NATIONAL(FOREKAYE),
    SPECIES_TO_NATIONAL(HELLMO),
	...
	//SPECIES_TO_NATIONAL(FONDAUNT),
	SPECIES_TO_NATIONAL(ROB3R),
    SPECIES_TO_NATIONAL(SKORCHOP),
    SPECIES_TO_NATIONAL(CUBEAST),
    SPECIES_TO_NATIONAL(BEASTUNT),
	SPECIES_TO_NATIONAL(ASTLURE),
    SPECIES_TO_NATIONAL(HOOTUBE),
    SPECIES_TO_NATIONAL(CHANNOWL),
	SPECIES_TO_NATIONAL(PUPPARMY),
    SPECIES_TO_NATIONAL(FANDAM),
    SPECIES_TO_NATIONAL(PEWCO),
    SPECIES_TO_NATIONAL(PANZERAGE),
    SPECIES_TO_NATIONAL(SQUEEGEE),
    SPECIES_TO_NATIONAL(WHYTEEPEE),
    SPECIES_TO_NATIONAL(SHITPOSTAR),
    SPECIES_TO_NATIONAL(MUSTELIT),
    SPECIES_TO_NATIONAL(CAPENSEAR),
    SPECIES_TO_NATIONAL(SMOGARETTE),
	SPECIES_TO_NATIONAL(METOXIC),
    SPECIES_TO_NATIONAL(ILLUMARYD),
    SPECIES_TO_NATIONAL(ENLIMINATI),
    SPECIES_TO_NATIONAL(POSTLE),
    SPECIES_TO_NATIONAL(HUSHBACK),
    SPECIES_TO_NATIONAL(LYSALCHI),
	SPECIES_TO_NATIONAL(DRACCOON),
    ...
    SPECIES_TO_NATIONAL(DUYUKNO),
    SPECIES_TO_NATIONAL(HALFIST),
    SPECIES_TO_NATIONAL(INEVITON),
	//SPECIES_TO_NATIONAL(AERODACTYL),
	SPECIES_TO_NATIONAL(BAYPUP),
    SPECIES_TO_NATIONAL(SHARPARENT),
    SPECIES_TO_NATIONAL(MEGRANDON),
    SPECIES_TO_NATIONAL(SINDIVIDUA),
    SPECIES_TO_NATIONAL(POWERRUPT),
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_COVILED - 1] = 0x1d,
    [SPECIES_CONTRIP - 1] = 0x06,
    [SPECIES_PLUNGEMENT - 1] = 0x45,
    [SPECIES_ACCIDROP - 1] = 0x49,
    [SPECIES_PARAS - 1] = 0x46,
    [SPECIES_PARASECT - 1] = 0x0f,
    [SPECIES_VENONAT - 1] = 0x06,
    [SPECIES_BINYOTAKE- 1] = 0x06,
    [SPECIES_SVAMPELETT- 1] = 0x06,
	[SPECIES_KRABADICT- 1] = 0x06,
	[SPECIES_KETAGENE- 1] = 0x06,
	[SPECIES_SHORTS- 1] = 0x06,
	...
	[SPECIES_TELECO- 1] = 0x06,
	[SPECIES_ESAKIT- 1] = 0x06,
	[SPECIES_FOREKAYE- 1] = 0x06,
	[SPECIES_HELLMO- 1] = 0x06,
    [SPECIES_RANDOMAIL- 1] = 0x06,
    [SPECIES_DEDLIVERY- 1] = 0x06,
	[SPECIES_BROYALTY- 1] = 0x06,
    ...
    [SPECIES_JYNX - 1] = 0x17,
    [SPECIES_ELECTABUZZ - 1] = 0x06,
    [SPECIES_MAGMAR - 1] = 0x06,
    [SPECIES_PINSIR - 1] = 0x06,
    [SPECIES_TAUROS - 1] = 0x06,
    [SPECIES_MAGIKARP - 1] = 0x06,
    [SPECIES_GYARADOS - 1] = 0x06,
    [SPECIES_LAPRAS - 1] = 0x06,
    [SPECIES_DITTO - 1] = 0x06,
    [SPECIES_EEVEE - 1] = 0x06,
    [SPECIES_VAPOREON - 1] = 0x06,
    [SPECIES_JOLTEON - 1] = 0x06,
    [SPECIES_FLAREON - 1] = 0x06,
    [SPECIES_PORYGON - 1] = 0x06,
    [SPECIES_OMANYTE - 1] = 0x06,
    [SPECIES_OMASTAR - 1] = 0x06,
    [SPECIES_KABUTO - 1] = 0x06,
    [SPECIES_KABUTOPS - 1] = 0x06,
    [SPECIES_HALFIST - 1] = 0x06,
    [SPECIES_INEVITON - 1] = 0x06,
    [SPECIES_ARTICUNO - 1] = 0x06,
